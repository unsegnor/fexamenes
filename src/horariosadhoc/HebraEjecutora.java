...
public class HebraEjecutora implements Runnable {
    ...
    HebraEjecutora(ControladorDeHebras control, ArrayList<Asignatura> asignaturas, int nhuecos, HashMap<ParAsig, Integer> afectados, int[] huecos) {
    ...
    public void run() {
            ...
            Sol sBL1 = Utiles.ALprimerMejor(solucion, afectados, huecos); //Primero mejoramos de forma aleatoria
            //System.out.println("--------------------------AL2-----------------------");
            //Sol sBL2 = Utiles.ALprimerMejor2(sBL1, dositemsets, huecos); //Después afinamos un poco
            //System.out.println("--------------------------BL-----------------------");
            Sol sBL = Utiles.BLprimerMejor(sBL1, afectados, huecos); //Después hacemos BL
            Evaluacion eval = Sol.evaluarComp(sBL, afectados, huecos);
